...
// Generate a random email for admin
String adminAccount = ('admin' + RandomStringUtils.randomNumeric(4)) + '@test.com'
...
WebUI.setText(findTestObject('Login/login_normal/Page_Accounts - PowerFolder/Email_place'), adminAccount)
...
WebUI.check(findTestObject('Login/login_normal/Page_Accounts - PowerFolder/ServerAdmin_case'))

WebUI.click(findTestObject('Login/login_normal/Page_Accounts - PowerFolder/button_Save'))

WebUI.verifyElementPresent(findTestObject('Login/login_normal/Page_Accounts - PowerFolder/span_Account created'), 1)

//Log in with the newly created admin account.
WebUI.navigateToUrl('https://lab.powerfolder.net:8666/login')

WebUI.setText(findTestObject('Object Repository/Login/Page_Login - PowerFolder/input_register new account_Username'), adminAccount)
