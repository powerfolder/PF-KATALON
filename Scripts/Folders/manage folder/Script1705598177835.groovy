...
Clipboard clipbaord = Toolkit.getDefaultToolkit().getSystemClipboard()

def clipboardData = clipbaord.getData(DataFlavor.stringFlavor)

println('Clipboard : ' + clipboardData)
